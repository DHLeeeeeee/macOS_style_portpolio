    ...
    <article className={style.about}>
      <div className={style.left}>
        ...
        <p>
          ...
          웹 개발자 양성 과정을 국비 지원으로 수료 했습니다. <br />
          이 과정에서 웹 개발에 대한 전반적인 지식을 습득하고 <br /> 그동안 개인적으로 진행해왔던 취미 프로젝트들을 통해 실습과 경험을 쌓았습니다. <br />
      ...
      <div className={style.right}>
        <div className={style.career}>
          <p>경력</p>
          <p>프론트엔드 개발자 양성과정 수료 2022.11.14 ~ 2023.04.24</p>
        </div>
        <div className={style.skill}>
          ...
          <ul>
            ...
            <li>
              ...
              <p>함수를 만들고 파라미터를 활용하여 사용가능합니다.</p>
